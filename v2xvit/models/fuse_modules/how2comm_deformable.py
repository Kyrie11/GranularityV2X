...
class How2comm(nn.Module):
    ...
    def forward(self, record_len, pairwise_t_matrix, delay=0, his_vox=None, his_feat=None, his_det=None):
        ...
        #把增强后的ego特征放入
        # 对ego的帧进行增强
        feat_bev_copy = self.get_enhanced_feature(feat_bev_copy, his_feat[1:], record_len)  # 取第0到第3帧作为历史
